var game = {
  ...
  "onload": function() {
    if (!me.video.init("screen", 1024, 600, true, 'auto')) {
  ...
  "loaded": function() {
    ...
    me.game.viewport.setBounds(0, 0, 1024, 600);
...
var Share = me.GUI_Object.extend({
  ...
  onClick: function(event) {
    var shareText = 'Just made ' + game.data.steps + ' steps on Balot! Can you beat me? Download now!';
